# -*- coding: utf-8 -*-
#
# ploneorg.addonlisting documentation build configuration file, created by
...
project = u'ploneorg.addonlisting'
copyright = u'2017, Plone Foundation and Contributors'
...
htmlhelp_basename = 'ploneorg_addonlisting_doc'
...
latex_documents = [
    (master_doc,
     'plone_addonlisting.tex',
     u'Ploneorg Addonlisting Documentation',
     u'Alexander Loechel',
     'manual'),
]
...
man_pages = [
    (master_doc, 'ploneorg_addonlisting',
     u'PloneOrg Addonlisting Documentation',
     [author],
     1)
]
...
texinfo_documents = [
    (master_doc,
     ...
     author,
     'ploneorg.addonlisting',
     'A Plugin that make Add-Ons accessible via a Plone instance.',
     'Miscellaneous'),
]
